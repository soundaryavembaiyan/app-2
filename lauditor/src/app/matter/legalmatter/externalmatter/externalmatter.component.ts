...
@Component({
  selector: 'app-externalmatter',
  templateUrl: './externalmatter.component.html',
  styleUrls: ['./externalmatter.component.scss']
})

export class ExternalmatterComponent implements OnInit {
  ...
  value: any = 1;
  options: any = [
    { name: "External Matters", value: 1 }, 
    { name: "Internal Matters", value: 2 }
  ];
  selectedOption: any;
