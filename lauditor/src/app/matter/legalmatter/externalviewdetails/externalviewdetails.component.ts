...
@Component({
  selector: 'app-externalviewdetails',
  templateUrl: './externalviewdetails.component.html',
  styleUrls: ['./externalviewdetails.component.scss']
})
export class ExternalviewdetailsComponent implements OnInit {
